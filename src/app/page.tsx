...
import { Play, Tv, Video, Search, ChevronLeft, ChevronRight } from 'lucide-react';
...
interface Stream {
  ...
  statusCheckedAt DateTime | null; // Last time status was checked
  quality      string | null;  // "hd", "fhd", "sd", "4k"
  createdAt    string;
  updatedAt    string;
}
...
export default function Home() {
  ...
  // Paginate streams
  const totalPages = Math.ceil(filteredStreams.length / pageSize);
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm text-slate-600 dark:text-slate-400">
              {filteredStreams.length} قناة متاحة
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <div className="relative mb-8 max-w-2xl mx-auto">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 text-lg border-2 border-slate-300 rounded-xl focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-all bg-white dark:bg-slate-800 dark:border-slate-700 dark:text-white"
          />
        </div>
        ...
        {!loading && filteredStreams.length > 0 && totalPages > 1 && (
          <div className="flex items-center justify-center gap-4 mt-12 mb-8">
            ...
            <div className="flex items-center gap-3 bg-white dark:bg-slate-800 px-6 py-3 rounded-xl border-2 border-slate-300 dark:border-slate-700">
              ...
              <span className="text-slate-600 dark:text-slate-400">من</span>
